...
title_set='$MnBi_2Te_4$ band structure'
de=0.1002  # The difference between the Fermi energies of self- and non self-consistant calculation, respectively. nonself - self
ybottom=-1.5  # Energy limit
yupper=1.5   # Energy limit
label_set="DFT"
group_labels=[]
x=[]
...
axe.set_title(title_set,fontsize=20,fontname='arial')
#axe.set_xlabel(r'$\mathbf{k}$-points',fontsize=13)
axe.set_ylabel(r'${E}$-$E_{f}$ (eV)',fontdict=font)
axe.set_xticks(x)
plt.yticks(fontsize=15,fontname='arial')
#plt.yticks(fontdict=ticksfont)
axe.set_xticklabels(group_labels, rotation=0,fontsize=12,fontname='arial')
